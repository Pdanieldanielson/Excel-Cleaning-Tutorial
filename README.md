...
**What is Data Analysis? Why clean data?**
<br/>
...
The job of a Data Analyst is to look at these events and understand the story from a third party's perspective. We seek to understand the facts. (Yes, that person at the bar last week was indeed flirting with you.) In order to understand the facts we need clean data.
